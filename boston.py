...
def build_model(df):
	...
	st.markdown("**1.3. Variables details**")
...
with st.sidebar.header("2. Learning Prameters"):
...
if uploaded_file is not None:
	...
	if st.button("Press to use exemple dataset"):
		boston = load_boston()
